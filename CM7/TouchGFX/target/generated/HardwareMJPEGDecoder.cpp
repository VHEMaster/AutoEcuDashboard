...
#define CHUNK_SIZE_OUT ((uint32_t)(MCU_CHROMA_420_SIZE_BYTES * (1920 / MCU_WIDTH_PIXELS)))
...
void HardwareMJPEGDecoder::decodeMJPEGFrame(const uint8_t* const mjpgdata, const uint32_t length, uint8_t* outputBuffer, uint16_t bufferWidth, uint16_t bufferHeight, uint32_t bufferStride)
{
    ...
    if (outputBuffer) /* only decode if buffers are assigned. */
    {
        ...
        JPEG_ConvertorParams.ScaledWidth = 1920 * JPEG_ConvertorParams.bytes_pr_pixel;
...
void DMA2D_CopyBuffer(JPEG_Data_BufferTypeDef& job)
{
    ...
    WRITE_REG(DMA2D->OOR, 1920 - (MCU_WIDTH_PIXELS * JPEG_ConvertorParams.MCU_pr_line));
