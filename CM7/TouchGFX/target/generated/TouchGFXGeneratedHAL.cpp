...
uint32_t videoRGBBuffer[2073600] LOCATION_ATTRIBUTE_NOLOAD("Video_RGB_Buffer");
DoubleBufferedVideoController<1, 1920, 720, 1920 * 3U, Bitmap::RGB888> videoController;
}
...
uint32_t frameBuf[(1920 * 720 * 3 + 3) / 4 * 2] LOCATION_ATTRIBUTE_NOLOAD("TouchGFX_Framebuffer");
